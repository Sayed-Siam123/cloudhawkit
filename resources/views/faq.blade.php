...
<!-- Mirrored from www.inventheme.com/themeforest/axoma/axoma/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2019 19:52:12 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <section class="page-title-section theme-after" style="background-image:url(static/img/banner-1.png);">
        <div class="container">
          <div class="page-title">
            <h1 class="font-alt">Frequently Asked Questions</h1>
    ...
    <section class="section gray-bg">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-4">
            <div class="faq-menu md-m-30px-b">
              <ul class="list-type-01">
                <li class="theme-after"><a href="#">Understanding Your Account</a></li>
                <li class="theme-after"><a href="#">Forgot Your Password</a></li>
                <li class="theme-after"><a href="#">Updating Your Account Details</a></li>
                <li class="theme-after"><a href="#">Cancelling Your Subscription</a></li>
                <li class="theme-after"><a href="#">Renewing Your Subscription</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-8">
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-1">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-1" data-aria-expanded="true" data-aria-controls="faqc-1">
                    <span class="no theme-bg">1</span> How can I install/upgrade Dummy Content?
                  </h5>
                </div>
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-2">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-2" data-aria-expanded="true" data-aria-controls="faqc-2">
                    <span class="no theme-bg">2</span> Dummy Content won't install...
                  </h5>
                </div>
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-3">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-3" data-aria-expanded="true" data-aria-controls="faqc-3">
                    <span class="no theme-bg">3</span> How can I uninstall Dummy Content?
                  </h5>
                </div>
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-4">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-4" data-aria-expanded="true" data-aria-controls="faqc-4">
                    <span class="no theme-bg">4</span> What are the minimum requirements?
                  </h5>
                </div>
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-5">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-5" data-aria-expanded="true" data-aria-controls="faqc-5">
                    <span class="no theme-bg">5</span> Where can I download earlier versions?
                  </h5>
                </div>
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-6">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-6" data-aria-expanded="true" data-aria-controls="faqc-6">
                    <span class="no theme-bg">6</span> How can I downgrade to an earlier version of Dummy Content?
                  </h5>
                </div>
              ...
              <div class="faq-row">
                <div class="faq-header" id="faqa-7">
                  <h5 class="faq-title" data-toggle="collapse" data-target="#faqc-8" data-aria-expanded="true" data-aria-controls="faqc-8">
                    <span class="no theme-bg">7</span> How can I upgrade from Joomla 2.5 to Joomla 3?
                  </h5>
                </div>
