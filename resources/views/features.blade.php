...
<!-- Mirrored from www.inventheme.com/themeforest/axoma/axoma/features.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2019 19:52:12 GMT -->
<head>
  <meta charset="utf-8">
...
<body data-spy="scroll" data-target="#navbar" data-offset="98">
          ...
          <ul class="navbar-nav ml-auto align-items-center">
            <li class="m-dropdown m-dropdown-multilevel">
              ...
              <ul class="m-dropdown-menu">
                  ...
                  <li><a href="index-2.html">Home Option 2</a></li>
                  <li><a href="index-3.html">Home Option 3</a></li>
                  <li><a href="index-4.html">Home Option 4</a></li>
                  <li><a href="index-5.html">Home Option 5</a></li>
                  <li><a href="index-6.html">Home Option 6</a></li>
                  <li><a href="index-7.html">Home Option 7</a></li>
                  <li><a href="index-8.html">Home Option 8</a></li>
              </ul>
            </li>

            <li><a class="nav-link" href="index.html#about">About</a></li>
            <li><a class="nav-link" href="index.html#feature">Features</a></li>
            ...
            <li><a class="nav-link-btn btn btn-white m-25px-l md-m-0px-l" href="#">Sign In</a></li>
          </ul>
        </div>
        <!-- / -->
  ...
  <main>
    ...
    =============================
    -->
    <section class="page-title-section theme-after" style="background-image:url(static/img/banner-1.png);">
        <div class="container">
          <div class="page-title">
            <h1 class="font-alt">Our Features</h1>
          ...
          <div class="col-md-12">
            <div class="tab-style-1">
              <ul class="nav justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link theme-after active" id="pills-Features-tab" data-toggle="pill" href="#pills-Features" role="tab" aria-controls="pills-Features" aria-selected="false">Features</a>
                </li>

                <li class="nav-item">
                  <a class="nav-link theme-after" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Overview</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link theme-after" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Intergration</a>
                </li>
              </ul>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-Features" role="tabpanel" aria-labelledby="pills-Features-tab">
                  <div class="row align-items-center">
                    <div class="col-md-6">
                      <img src="static/img/feature-3.svg" title="" alt="">
                    </div> <!-- col -->
                    <div class="col-md-6 sm-m-30px-t">
                      <div class="card-box-01 p-50px-l  md-p-0px-l">
                        <h3 class="font-alt dark-color">The Leader in Website Design</h3>
                        ...
                        <div class="btn-bar">
                          <a class="btn btn-theme" href="#">Get Start</a>
                        </div>
                      </div>
                    </div>
                  </div> <!-- row -->
                ...
                <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <div class="row align-items-center">
                    <div class="col-md-6 sm-m-30px-b">
                      <div class="card-box-01 p-50px-r md-p-0px-r">
                        <h3 class="font-alt dark-color theme-after">The Leader in Website Design</h3>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                        <div class="btn-bar">
                          <a class="btn btn-theme" href="#">Get Start</a>
                    ...
                    <div class="col-md-6">
                      <img src="static/img/feature-4.svg" title="" alt="">
                    </div> <!-- col -->
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                  <div class="row align-items-center">
                    <div class="col-md-6">
                      <img src="static/img/feature-5.svg" title="" alt="">
                    </div> <!-- col -->
      ...
      <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 md-m-30px-b text-center">
              <img src="static/img/feature-10.svg" title="" alt="">
            </div>
            <div class="col-lg-6">
              <div class="std-box-01 md-m-40px-t">
                ...
                <ul class="list-type-01">
                  <li class="theme-after">
                    <h6 class="dark-color">Create Your interface</h6>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                  </li>
                  <li class="theme-after">
                    <h6 class="dark-color">Works everywhere you go</h6>
    ...
    <section class="section">
      <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
              <img src="static/img/feature-8.png" title="" alt="">
            </div>
            <div class="col-md-6">
              <div class="std-box-01 md-m-40px-t">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <ul class="list-type-01">
                  <li class="theme-after">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</li>
                  <li class="theme-after">quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.</li>
                </ul>
                <div class="btn-bar">
        ...
        <div class="row justify-content-center m-60px-b sm-m-40px-b">
          <div class="col-lg-8 col-md-10">
            <div class="section-title text-center">
              <h6 class="theme-color">We are the best</h6>
              <h2 class="dark-color font-alt">Manage Everything in One Place.</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-7">
            <div class="ss-slider">
              <div class="owl-carousel" data-items="1" data-nav-dots="true" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="0" data-nav-arrow="false">
                <div>
                  <img src="static/img/ss-1.jpg" title="" alt="">
                </div>
                <div>
                  <img src="static/img/ss2.jpg" title="" alt="">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-5">
            <div class="std-box p-50px-l md-p-0px-l md-m-40px-t">
              <h4 class="font-alt dark-color">The Leader in Website Design</h4>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam .</p>
              <ul class="list-type">
                <li><i class="fas fa-check theme-bg"></i>Sed volutpat mollis dui rutrum.</li>
                <li><i class="fas fa-check theme-bg"></i>Donec ac nisi non quam cursus.</li>
              </ul>
              <div class="btn-bar">
                <a class="btn btn-theme" href="#">Lear More</a>
              </div>
            </div>
          </div>
        </div> <!-- row -->

        <div class="row p-100px-t md-p-60px-t align-items-center">
          <div class="col-lg-5 order-last order-lg-first">
            <div class="std-box p-50px-r md-p-0px-r md-m-40px-t">
              <h4 class="font-alt dark-color">The Leader in Website Design</h4>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam .</p>
              <ul class="list-type">
                <li><i class="fas fa-check theme-bg"></i>Sed volutpat mollis dui rutrum.</li>
