...
<!-- Mirrored from www.inventheme.com/themeforest/axoma/axoma/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2019 19:52:12 GMT -->
<head>
  <meta charset="utf-8">
...
<body data-spy="scroll" data-target="#navbar" data-offset="98">
  ...
  <main>
    ...
    =============================
    -->
    <section class="section bg-effect-box gray-bg">
      
      <div class="container">
        <div class="row">
          <div class="col-lg-4 md-m-50px-b">
            <div class="section-title-02">
              <h2 class="dark-color font-alt theme-after">Our Services</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
              <div class="btn-bar">
                <a href="#" class="btn btn-theme">Free Try</a>
              </div>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
            <div class="col-sm-6 m-40px-b">
              <div class="feature-box-03">
                <div class="icon theme-after">
                  <i class="ti-check-box theme-color"></i>
                </div>
            ...
            <div class="col-sm-6 m-40px-b">
              <div class="feature-box-03">
                <div class="icon theme-after">
                  <i class="ti-rocket theme-color"></i>
                </div>
                <div class="feature-content">
            ...
            <div class="col-sm-6 m-40px-b">
              <div class="feature-box-03">
                <div class="icon theme-after">
                  <i class="ti-headphone theme-color"></i>
                </div>
                <div class="feature-content">
            ...
            <div class="col-sm-6 m-40px-b">
              <div class="feature-box-03">
                <div class="icon theme-after">
                  <i class="ti-flag-alt theme-color"></i>
                </div>
                <div class="feature-content">
            ...
            <div class="col-sm-6 sm-m-40px-b">
              <div class="feature-box-03">
                <div class="icon theme-after">
                  <i class="ti-headphone theme-color"></i>
                </div>
        ...
        <div class="row justify-content-center m-45px-b sm-m-25px-b">
          <div class="col-lg-8 col-md-10">
            <div class="section-title text-center">
              ...
              <h2 class="dark-color font-alt theme-after">How It Works?</h2>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 m-15px-tb">
              <div class="feature-box-02 text-center">
                ...
                <a class="link yellow-bg-after" href="#"><i class="yellow-bg ti-arrow-right"></i></a>
              </div>
            </div> <!-- col -->
    ...
    <section class="section gray-bg">
      <div class="container">
        <div class="row justify-content-center m-45px-b sm-m-25px-b">
          <div class="col-lg-8 col-md-10">
            <div class="section-title text-center">
              <h6 class="theme-color">Features</h6>
              <h2 class="dark-color font-alt theme-after">We Provide Best Feature for You Customers.</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 m-15px-tb">
            <div class="feature-box-01">
              <div class="img">
                <img src="static/img/feature-1.png" title="" alt="">
              </div>
              <div class="feature-content">
                <h6 class="dark-color font-alt">Check Your Status</h6>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                <a class="theme-color more" href="#">Read More</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 m-15px-tb">
            <div class="feature-box-01">
              ...
              <div class="feature-content">
                <h6 class="dark-color font-alt">Online Presentation</h6>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                <a class="theme-color more" href="#">Read More</a>
              </div>
            </div>
          ...
          <div class="col-md-4 m-15px-tb">
            <div class="feature-box-01">
              <div class="img">
                <img src="static/img/feature-3.png" title="" alt="">
              </div>
              <div class="feature-content">
                <h6 class="dark-color font-alt">Access Anywhere</h6>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                <a class="theme-color more" href="#">Read More</a>
              </div>
            </div>
